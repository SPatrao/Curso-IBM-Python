class Libro:
    ...
    # Convertido a método de clase en lugar de método estático
    @classmethod
    def agregar(cls):
        ...
        return cls(titulo, autor, isbn)  # Usa cls en vez de Libro
...
if __name__ == "__main__":
    while True:
        ...
        if opcion == '1':
            nuevo_libro = Libro.agregar()  # Esta línea sigue igual
